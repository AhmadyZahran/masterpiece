        ...
        <div id="top-header">
            <div class="container">
                <ul class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +96279608675</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> info@zahran.jo</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i> zarqa The commercial center behind the old
                            mall</a></li>
                </ul>
                                    ...
                                    <div class="cart-list">
                                        <div class="product-widget">
                                            ...
                                            <div class="product-body">
                                                <h3 class="product-name"><a href="../single product">product name goes
                                                        here</a></h3>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <span class="copyright">
                            All Rights Reserved © 2022 - zahran
                        </span>
                    </div>
                </div>
                <!-- /row -->
